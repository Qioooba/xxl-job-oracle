...
public class XxlJobInfoDaoTest {
	...
	public void save_load(){
		...
		info.setAddTime(new Timestamp(new Date().getTime()));
		info.setUpdateTime(new Timestamp(new Date().getTime()));
		info.setGlueUpdatetime(new Timestamp(new Date().getTime()));
		...
		info2.setGlueUpdatetime(new Timestamp(new Date().getTime()));
		info2.setChildJobId("1");

		info2.setUpdateTime(new Timestamp(new Date().getTime()));
